...
import { getNPCSprite, PlayerSprite, HouseSprite, TreeSprite, BridgeSprite, WaterTile } from './PixelSprites';
    ...
    <div className="relative w-full h-full flex items-center justify-center bg-gradient-to-br from-indigo-950 via-slate-900 to-purple-950 overflow-hidden">
      ...
      >
        ...
        >
          ...
          {/* 玩家角色 */}
          <div className="relative z-10 drop-shadow-[0_0_20px_rgba(6,182,212,1)]">
            <PlayerSprite />
          </div>
        </motion.div>
